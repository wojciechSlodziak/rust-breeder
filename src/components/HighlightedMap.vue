<template>
  <div class="d-flex flex-column align-center">
    ...
    <div class="highlighted-map_tip mt-2 mb-2 px-3 px-sm-0" v-if="map && map.chance < 1">
      Place plants with an "E" next to the <v-icon size="large">mdi-compass-rose</v-icon> (compass) in the most east
      slot of the planter box, and plants with a "W" in the most west slot to influence the crossbreeding for the
      desired result.
      <a
